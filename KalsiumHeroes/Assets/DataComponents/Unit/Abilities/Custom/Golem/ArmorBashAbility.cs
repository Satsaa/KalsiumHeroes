...
{
    public new ArmorBashAbilityData data => (ArmorBashAbilityData)base.data;
    ...
    float CalculateDamage(Unit target) {
        ...
        print("Damage: " + damage + " (Golem Defense " + unit.data.defense.value + " - Target Defense " + target.data.defense.value + ")");
        return damage;
    }
}
