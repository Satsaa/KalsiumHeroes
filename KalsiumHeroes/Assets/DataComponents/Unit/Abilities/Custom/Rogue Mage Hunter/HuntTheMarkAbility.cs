...
{
    public new HuntTheMarkAbilityData data => (HuntTheMarkAbilityData)base.data;
        ...
        return new InstantAbilityHandler(msg, this, (ability) => {
            ...
            foreach (var tile in aoe) {
                if (tile.unit) {
                    ...
                    if (tile.unit.modifiers.Get<MarkOfPreyStatus>().Any()) tile.unit.modifiers.Get<MarkOfPreyStatus>().First().Destroy();
