...
public static class DataComponentExtensions {
	...
	public static DataComponent AddDataComponent(this DataComponent component, MasterComponentData dataSource, Action<DataComponent> initializer = null) {
	...
	[Obsolete("Create MasterComponents with MasterComponent.Instantiate or Cast dataSource to DataComponentData to override this warning.")]
	public static DataComponent AddDataComponent<T>(this DataComponent component, MasterComponentData dataSource, Action<T> initializer = null) where T : DataComponent {
		throw new NotSupportedException("Create MasterComponents with MasterComponent.Instantiate or Cast dataSource to DataComponentData to override this warning.");
	}
	...
	/// </summary>
	/// <param name="component">Target GameObject</param>
	...
	public static DataComponent AddDataComponent(this DataComponent component, DataComponentData dataSource, Action<DataComponent> initializer = null)
		=> AddDataComponent(component.gameObject, dataSource, initializer);
	...
	/// <typeparam name="T">Type of created DataComponent</typeparam>
	/// <returns>The created DataComponent.</returns>
	public static T AddDataComponent<T>(this DataComponent component, DataComponentData dataSource, Action<T> initializer = null) where T : DataComponent
		=> AddDataComponent<T>(component.gameObject, dataSource, initializer);
