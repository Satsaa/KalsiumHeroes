...
public class PathConfirmAbilityTargeter : ConfirmHexAbilityTargeter {

  public PathConfirmAbilityTargeter(Unit unit, Ability ability, Action<Targeter> onComplete, Action<Targeter> onCancel)
