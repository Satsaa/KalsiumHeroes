...
Shader "Universal Render Pipeline/NiloCat Extension/Screen Space Decal/Unlit"
{
    Properties
    {
        ...
        [Header(Fade Discard Angle(Fades the decal when scene normal nears discard treshold))]
        [Toggle(_ProjectionAngleDiscardFadeEnable)] _ProjectionAngleDiscardFadeEnable("_ProjectionAngleDiscardFadeEnable (default = off)", float) = 0
        _ProjectionAngleDiscardFade("_ProjectionAngleDiscardFade (default = 0)", range(0,2)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _ProjectionAngleDiscardFadeEnable
            ...
            CBUFFER_START(UnityPerMaterial)               
                ...
                float _ProjectionAngleDiscardFade;
                half4 _Color;
                half2 _AlphaRemap;
                half _MulAlphaToRGB;
            CBUFFER_END
...
#if _ProjectionAngleDiscardFadeEnable
                float alphaMult = clamp(0,1,(decalSpaceHardNormal.z - _ProjectionAngleDiscardThreshold) / _ProjectionAngleDiscardFade);
#endif
#endif
                // call discard
...
#if _ProjectionAngleDiscardEnable && _ProjectionAngleDiscardFadeEnable
                col.a = col.a * alphaMult;// discard fade
#endif
