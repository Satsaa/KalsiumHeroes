...
This is a modified version of the FastPriorityQueue.
Using a IComparer for priority values. Instead of just a float float comparison.
...
namespace Priority_Queue {
	...
	public sealed class ComparisonPriorityQueue<T> : IFixedSizePriorityQueue<T, float>
		...
		public ComparisonPriorityQueue(int maxNodes, IComparer<T> comparer) {
			_numNodes = 0;
		...
		private bool HasHigherPriority(T higher, T lower) {
			int comp = _comparer.Compare(higher, lower);
			return comp < 0;
